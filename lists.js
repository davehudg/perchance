...
const eyebrowsVt = [{ value: "", text: "", toolTip: "" }, { value: "arched eyebrows", text: "Arched Eyebrows", toolTip: "These eyebrows have a high, curved shape that peaks in the middle, creating a dramatic and often sophisticated look." },
    ...
    { value: "slightly arched eyebrows", text: "Slightly Arched Eyebrows", toolTip: "These eyebrows have a subtle curve that's not as pronounced as the arched brows, offering a more relaxed yet still defined look." }];
...
const noseModVt = [{ value: "", text: "", toolTip: "" }, { value: "broad", text: "Broad", toolTip: "A nose that is wider at the bridge and can give a strong, bold look." },
...
const noseBridgeVt = [{ value: "", text: "", toolTip: "" }, { value: "with flat nose bridge", text: "Flat Nose Bridge", toolTip: "A nose with a minimal to non-existent ridge between the eyes." },
...
const lipModVt = [{ value: "", text: "", toolTip: "" }, { value: "pouty", text: "Pouty", toolTip: "Lips that have a natural or exaggerated fullness to the lower lip, creating a pouting or kissable look." },
...
const jawlineVt = [{ value: "", text: "", toolTip: "" }, { value: "strong jawline with ", text: "Strong Jawline", toolTip: "A jawline that is well-defined and angular." },
...
const foreheadVt = [{ value: "", text: "" }, { value: "high forehead", text: "high forehead" }, { value: "low forehead", text: "low forehead" }, { value: "broad forehead", text: "broad forehead" }, { value: "narrow forehead", text: "narrow forehead" }];
const heightVt = [{ value: "", text: "" }, { value: "short", text: "short" }, { value: "average height", text: "average height" }, { value: "tall", text: "tall" }];
const maleHairStyles = [{ value: "comb over", text: "Comb Over" }, { value: "quiff", text: "Quiff" }, { value: "buzz cut", text: "Buzz Cut" }, { value: "crew cut", text: "Crew Cut" }, { value: "short afro", text: "Short Afro" }, { value: "afro", text: "Afro" }, { value: "side part with short heir", text: "Side Part With Short Heir" }, { value: "ivy league haircut", text: "Ivy League Haircut" }, { value: "fade", text: "Fade" }, { value: "slicked back", text: "Slicked Back" }, { value: "textured crop", text: "Textured Crop" }];
const femaleHairStyles = [{ value: "pixie cut", text: "Pixie Cut" }, { value: "textured pixie cut", text: "Textured Pixie Cut" }, { value: "bob", text: "Bob" }, { value: "side-swept bangs", text: "Side-Swept Bangs" }, { value: "rachel hair style", text: "Rachel Hair Style" }, { value: "balayage highlights", text: "Balayage Highlights" }, { value: "loose waves", text: "Loose Waves" }, { value: "braids", text: "Braids" }, { value: "updo", text: "Updo" }, { value: "high ponytail", text: "High Ponytail" }, { value: "long layered hair", text: "Long Layered Hair" }, { value: "long hair with bangs", text: "Long Hair With Bangs" }];
const ageVt = [{ value: "infant", text: "Infant" }, { value: "toddler", text: "Toddler" }, { value: "preschooler", text: "Preschooler" }, { value: "child", text: "Child" }, { value: "pre-teen", text: "Pre-Teen" }, { value: "teenager", text: "Teenager" }, { value: "young adult", text: "Young Adult" }, { value: "adult", text: "Adult" }, { value: "middle-aged", text: "Middle-Aged" }, { value: "senior", text: "Senior" }, { value: "elderly", text: "Elderly" }, { value: "geriatric", text: "Geriatric" }];
const skinColorVt = [{ value: "fair skin", text: "Fair" }, { value: "Ivory colored skin", text: "Ivory" }, { value: "Beige colored skin", text: "Beige" }, { value: "Caramel colored skin", text: "Caramel" }, { value: "Honey colored skin", text: "Honey" }, { value: "Toffee colored skin", text: "Toffee" }, { value: "Chestnut colored skin", text: "Chestnut" }, { value: "Walnut colored skin", text: "Walnut" }, { value: "Mocha colored skin", text: "Mocha" }, { value: "Cocoa colored skin", text: "Cocoa" }, { value: "chocolate colored skin", text: "Chocolate" }, { value: "dark chocolate colored skin", text: "Dark Chocolate" }];
const eyeColorVt = [{ value: "grey eyes", text: "Grey" }, { value: "blue eyes", text: "Blue" }, { value: "green eyes", text: "Green" }, { value: "brown eyes", text: "Brown" }, { value: "hazel eyes", text: "Hazel" }];
const glassesVt = [{ value: "cat eye glasses", text: "Cat Eye" }, { value: "browline glasses", text: "Browline" }, { value: "oval glasses", text: "Oval" }, { value: "rectangle glasses", text: "Rectangle" }, { value: "round glasses", text: "Round" }, { value: "aviator glasses", text: "Aviators" }, { value: "sunglasses", text: "Sunglasses" }];
const frecklesVt = [{ value: "light freckles", text: "Light freckles" }, { value: "freckles on the bridge of nose", text: "bridge of nose" }, { value: "heavy freckles", text: "Heavy freckles" }];
const facialHairVt = [{ value: "clean-shaven", text: "Clean-shaven" }, { value: "stubble", text: "Stubble" }, { value: "short beard", text: "Short Beard" }, { value: "medium beard", text: "Medium Beard" }, { value: "long beard", text: "Long Beard" }, { value: "very long beard", text: "Very Long Beard" }, { value: "mustache", text: "Mustache" }, { value: "goatee", text: "Goatee" }, { value: "van dyke", text: "Van Dyke" }, { value: "soul patch", text: "Soul Patch" }, { value: "chin strap", text: "Chin Strap" }, { value: "mutton chops", text: "Mutton Chops" }, { value: "beardstache", text: "Beardstache" }, { value: "ducktail", text: "Ducktail" }, { value: "balbo", text: "Balbo" }, { value: "verdi", text: "Verdi" }];
const faceFeatsVt = [{ value: "faceShape", text: "Face Shape" }, { value: "faceLength", text: "Face Length" }, { value: "hairline", text: "Hairline" }, { value: "forehead", text: "Forehead" }, { value: "eyebrows", text: "Eyebrows" }, { value: "browRidge", text: "Brow Ridge" }, { value: "eyeShape", text: "Eye Shape" }, { value: "eyeSet", text: "Eye Set" }, { value: "nose", text: "Nose" }, { value: "cheekBones", text: "Cheek Bones" }, { value: "lips", text: "Lips" }, { value: "chin", text: "Chin" }];
const bodyFeatsVt = [{ value: "bodyType", text: "Body Type" }, { value: "bodyComp", text: "Body Composition" }, { value: "muscularity", text: "Muscularity" }, { value: "height", text: "Height" }, { value: "bustSize", text: "Bust Size" }];
const hairColorVt = [{ value: "", text: "" }, { value: "black hair", text: "Black" }, { value: "dark brown hair", text: "Dark Brown" }, { value: "brown hair", text: "Brown" }, { value: "sandy brown hair", text: "Sandy Brown" }, { value: "blonde hair", text: "Blonde" }, { value: "strawberry blonde hair", text: "Strawberry Blonde" }, { value: "red hair", text: "Red" }, { value: "auburn hair", text: "Auburn" }, { value: "grey hair", text: "Grey" }, { value: "white hair", text: "White" }, { value: "salt and pepper hair", text: "Salt and Pepper" }, { value: "bald", text: "Bald" }];
const highlightVt = [{ value: "", text: "None" }, { value: "with blonde highlights", text: "Blonde" }, { value: "with auburn highlights", text: "Auburn" }, { value: "with red highlights", text: "Red" }, { value: "with orange highlights", text: "Orange" }, { value: "with yellow highlights", text: "Yellow" }, { value: "with green highlights", text: "Green" }, { value: "with blue highlights", text: "Blue" }, { value: "with violet highlights", text: "Violet" }, { value: "with indigo highlights", text: "Indigo" }, { value: "with white highlights", text: "White" }, { value: "with black highlights", text: "Black" }];
