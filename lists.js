...
const faceShapeVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "flat face", text: "Flat Face", toolTip: "A face shape with minimal angles, a broad forehead, and a softly rounded jawline, creating a generally uniform appearance." },
...
const faceLengthVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "short face", text: "Short Face", toolTip: "A face where the distance from the forehead to the chin is less than the distance from ear to ear, often associated with a more rounded or heart-shaped face." },
...
const hairlineVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "natural hairline", text: "Natural Hairline", toolTip: "A hairline that follows the natural growth pattern without significant alteration." },
...
const eyebrowsVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "arched eyebrows", text: "Arched Eyebrows", toolTip: "These eyebrows have a high, curved shape that peaks in the middle, creating a dramatic and often sophisticated look." },
...
const eyebrowModVt = [
    { value: "thick", text: "Thick", toolTip: "" },
...
const browRidgeVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "faint brow ridge", text: "Faint", toolTip: "The brow ridge is barely perceptible, almost blending into the forehead for a very smooth look." },
...
const eyeShapeVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "almond shaped eyes", text: "Almond Eye", toolTip: "An eye shape that is longer than it is wide, with a slight curve at the outer corners, resembling an almond." },
...
const eyeSetVt = [{ value: "", text: "", toolTip: "" },
    { value: "wide eye set", text: "Wide Eye Set", toolTip: "Eyes that are spaced farther apart on the face, often contributing to a more open and friendly expression." },
...
const noseVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "straight nose", text: "Straight Nose", toolTip: "A nose that runs in a straight line from the bridge to the tip." },
...
const noseModVt = [
    { value: "broad", text: "Broad", toolTip: "A nose that is wider at the bridge and can give a strong, bold look." },
...
const noseBridgeVt = [
    { value: "with flat nose bridge", text: "Flat Nose Bridge", toolTip: "A nose with a minimal to non-existent ridge between the eyes." },
...
const cheekBonesVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "high cheekbones", text: "High Cheekbones", toolTip: "The most prominent of all, high cheekbones create a sharp, angular face with a dramatic contour that can make the face appear chiseled and elegant." },
...
const lipsVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "full lips", text: "Full Lips", toolTip: "Lips that are naturally plump and fill the space between the nose and chin, often associated with sensuality and beauty." },
...
const lipModVt = [
    { value: "pouty", text: "Pouty", toolTip: "Lips that have a natural or exaggerated fullness to the lower lip, creating a pouting or kissable look." },
...
const chinVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "pointed chin", text: "Pointed Chin", toolTip: "A chin that tapers to a sharp point, often giving the face a more elongated and angular appearance." },
...
const jawlineVt = [
    { value: "strong jawline with ", text: "Strong Jawline", toolTip: "A jawline that is well-defined and angular." },
...
const bodyTypeVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "inverted triangle body shape", text: "Inverted Triangle", toolTip: "Broad shoulders and a full bust that narrows down to smaller hips and thighs." },
...
const bodyCompVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "ectomorph build", text: "Ectomorph", toolTip: "Thin, with low body fat and minimal muscle definition." },
...
const muscularityVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "low muscle definition", text: "Low Muscle Definition", toolTip: "A body with minimal visible muscle tone and a higher body fat percentage that obscures the muscles." },
    ...
    { value: "toned muscle definition", text: "Toned Muscle Definition", toolTip: "" },
...
const bustSizeVt = [{ value: "", text: "", toolTip: "" }, 
    { value: "flat bust", text: "Flat Bust", toolTip: "A minimal amount of breast tissue, resulting in a chest that is almost level with the rest of the torso." },
...
const clothingVt = [{ value: "", text: "" }, 
    { value: "casual", text: "Casual" }, { value: "formal", text: "Formal" }, { value: "business", text: "Business" },
    { value: "nude", text: "None" }, { value: "underware", text: "Underware" }, { value: "swimwear", text: "Swimwear" }, 
